  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
      <Card className="shadow-sm bg-transparent border-0">
        <CardHeader>
          <CardTitle className="text-2xl font-semibold text-foreground">Assets</CardTitle>
        </CardHeader>
        <CardContent>
          {assets.length > 0 ? (
      ...
      <Card className="shadow-sm bg-transparent border-0">
        <CardHeader>
          <CardTitle className="text-2xl font-semibold text-foreground">Liabilities</CardTitle>
        </CardHeader>
        <CardContent>
